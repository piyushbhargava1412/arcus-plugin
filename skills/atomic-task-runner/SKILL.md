...
2. **Execute Loop**: Follow the **Iterative Development Loop** defined in `${skills_folder}/atomic-task-runner/references/iterative-development.md` (Red -> Green -> Refactor).
...
## Resources
- **Iterative Loop Guide**: `${skills_folder}/atomic-task-runner/references/iterative-development.md`
