...
- Draft the PR description using `${skills_folder}/pull-request-builder/assets/pr-template.md`.

### Step 3: Final Artifact Generation
- Run the full test suite one last time on the feature branch.
- Save the final, synthesized PR description to `.aforge/specs/[STORY-ID]/PR_DESCRIPTION.md`.
...
## Resources
- **PR Template**: `${skills_folder}/pull-request-builder/assets/pr-template.md`
