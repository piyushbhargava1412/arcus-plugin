...
### Step 3: Persistence
1. Use the `${skills_folder}/test-pattern-discovery/assets/testing-patterns.template.md` to generate the baseline.
...
- **Consult Specs**: See `${skills_folder}/test-pattern-discovery/references/testing-spec.md` for detailed extraction logic.
