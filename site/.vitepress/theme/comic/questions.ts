...
export const QUIZ: QuizQuestion[] = [
  ...
  { d: 'easy', q: 'What makes a skill different from an agent, at the simplest level?',
    ...
    a: 1, w: 'Skills live at plugins/arcus/skills/ and can be typed as /arcus:<name>; agents live flat under agents/ and are only ever dispatched by name.' },
  ...
  { d: 'easy', q: 'Which hook fires the moment an ARCUS session starts?',
    o: ['PreToolUse', 'PostCommit', 'SessionStart, running bootstrap.sh', 'GateOpen'],
    a: 2, w: 'hooks.json wires bootstrap.sh to the SessionStart event — it runs before anyone types a word.' },
  ...
  { d: 'medium', q: 'In gated mode, how does Angelina present each ambiguity to you?',
    o: ['A free-text prompt with no guidance', 'Exactly one Recommended option, a one-line rationale, and a custom-answer option', 'A multiple-choice list of five options', 'She never asks — she always decides herself'],
    a: 1, w: 'One recommended path per question keeps the dialogue fast without removing your ability to override it.' },
