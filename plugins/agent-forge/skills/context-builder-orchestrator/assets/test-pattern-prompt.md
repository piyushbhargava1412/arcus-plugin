...
1. Read and follow the `agent-forge:test-pattern-discovery` skill (it references its own template and specification internally).
2. Execute all steps defined in the skill (Step 0 through Step 3).
3. Persist output to `.context/testing-patterns.md`.
